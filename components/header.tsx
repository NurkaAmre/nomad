    ...
    <nav className='bg-[#131C27] text-white flex flex-col md:flex-row justify-between px-4 py-2 md:py-3 w-full fixed z-20'>
      ...
      <ul
        className={`${showMenu ? 'flex' : 'hidden'
          } md:flex flex-col md:flex-row tracking-wider md:gap-10 md:text-xl font-abhaya text-xl md:mt-2`}
      >
        <li>
      ...
      <div className='flex mt-6 md:mt-0 rounded-full px-1 mx-6 justify-center items-center w-4/3 md:w-1/6 bg-slate-50'>
